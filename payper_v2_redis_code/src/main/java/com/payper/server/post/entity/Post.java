...
@Table(name = "posts", indexes = {
        @Index(name = "idx_posts_merchant_created", columnList = "is_deleted, merchant_id, created_at DESC"),
        @Index(name = "idx_posts_merchant_type_created", columnList = "is_deleted, merchant_id, type, created_at DESC"),
        @Index(name = "idx_posts_deleted_created", columnList = "is_deleted, created_at DESC"),
})
